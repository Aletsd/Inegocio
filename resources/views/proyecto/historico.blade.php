                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <div id="accionesBtn" class="mt-2 acciones acciones1">
                                  <button class="acccion btn btn-primary btn-sm d-lg-block mr-1" onclick="RestaurarDocumento({{$documento->id}})"><i class="fa fa-folder-open"></i> <span>Restaurar</span></button>

                                  <button class="acccion btn btn-secondary btn btn-danger btn-sm d-lg-block" onclick="ElminarDocumentoPermanente({{$documento->id}})"><i class="fa fa-trash"></i> <span>Eliminar</span></button>
                                </div>
                            </td>
                        </tr>
                      @endforeach
